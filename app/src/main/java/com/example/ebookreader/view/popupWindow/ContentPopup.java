package com.example.ebookreader.view.popupWindow;
...
public class ContentPopup extends BasePopupWindow {
    ...
    protected View createConvertView() {
        return LayoutInflater.from(mContext)
                .inflate(R.layout.catalog_content, null);
    }
    ...
    public ContentPopup(Context context, Book book) {
        super(context);
        mBook = book;
        mLinearLayout = (LinearLayout) mConvertView.findViewById(R.id.content_linear_layout);
        mRecyclerView = (RecyclerView) mConvertView.findViewById(R.id.contents_recycle_view);
